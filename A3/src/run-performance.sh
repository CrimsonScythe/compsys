...
# Memory definitions
simplereal="-pipe simple -mem real"
simplemagic="-pipe simple -mem magic"

machine=""

if [[ "${2}" == "simplereal" ]]; then
  machine=${simplereal}
fi
if [[ "${2}" == "simplemagic" ]]; then
  machine=${simplemagic}
fi
...
elements="100 1000 10000 20000 25000 30000 35000 40000"
